                            ...
                            <div class="flex items-center gap-3">
                                <div class="relative w-full max-w-xs">
                                    ...
                                    <input wire:model.live="search" type="text" placeholder="Cari nama atau email..."
                                           class="w-full pl-10 pr-4 py-2 bg-white border border-slate-200/80 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10 text-slate-800 rounded-xl text-xs transition outline-none" />
                                </div>
